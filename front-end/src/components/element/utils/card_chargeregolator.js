...
// Componente visualizzazione card componente : Regolatore di carica
// Props:
...
export default function ChargeRegolatorCard(props){
    return(
        <Card>
            <Card.Content>
            <Card.Header>{props.serial}</Card.Header>
            <Card.Meta>
                <span className='info'>Regolatore carica</span>
            </Card.Meta>
            <Card.Description>
                <Typography variant="body1">Produttore: {props.manufacter}</Typography>
                <Typography variant="body1">Nome: {props.name}</Typography>
                <Typography variant="body1">Voltaggio sup.: {props.voltage}v</Typography>
                <Typography variant="body1">Amperaggio sup.: {props.amp}aH</Typography>
            </Card.Description>
            </Card.Content>
        </Card>
    )
